    ...
    <div className='mb-8 flex w-full max-w-full justify-center'>
      ...
      >
        <input
          ...
          className='text-1xl absolute -left-70 flex-1 bg-transparent px-75 text-left font-normal text-gray-500 *:bg-transparent placeholder:text-gray-500 focus:outline-none'
