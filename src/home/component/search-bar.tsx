    ...
    <div className='mb-8 flex w-full max-w-full justify-center'>
      ...
      >
        <input
          ...
          className='text-1xl -md:left-70 absolute -left-10 flex-1 bg-transparent px-15 text-left font-normal text-gray-500 *:bg-transparent placeholder:text-gray-500 focus:outline-none md:px-15'
